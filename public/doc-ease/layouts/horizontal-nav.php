<?php $horizontalLogoutCsrf = function_exists('csrf_token') ? (string) csrf_token() : ''; ?>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    ...
                                    <form action="auth-logout.php" method="post" class="m-0 p-0">
                                        <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($horizontalLogoutCsrf, ENT_QUOTES, 'UTF-8'); ?>">
