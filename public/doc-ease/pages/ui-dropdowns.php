                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">Place any freeform text within a dropdown menu with text and use spacing utilities. Note that youâ€™ll likely need additional sizing styles to constrain the menu width.</p>
