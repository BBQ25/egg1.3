                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">Similar to the contextual text color classes, set the background of an element to any contextual class. Background
                                        utilities <strong>do not set <code>color</code></strong>, so in some cases youâ€™ll want to use <code>.text-*</code>color utilities.</p>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted fs-14">Use border utilities to <b>add</b> an elementâ€™s borders. Choose from all borders or one at a time.</p>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted fs-14">Use border utilities to <b>remove</b> an elementâ€™s borders. Choose from all borders or one at a time.</p>
