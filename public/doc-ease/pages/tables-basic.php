                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">
                                        For basic stylingâ€”light padding and only horizontal dividersâ€”add the base class <code>.table</code> to any <code>&lt;table&gt;</code>.
                                    </p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">
                                        You can also invert the colorsâ€”with light text on dark backgroundsâ€”with <code>.table-dark</code>.
                                    </p>
