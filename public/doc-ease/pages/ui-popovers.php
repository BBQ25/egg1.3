                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted fs-14">Elements with the <code>disabled</code> attribute
                                            arenâ€™t interactive, meaning users cannot hover or click them to trigger a
                                            popover (or tooltip). As a workaround, youâ€™ll want to trigger the popover from a
