                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-secondary" role="alert">
                                        <strong>Secondary - </strong> A simple secondary alertâ€”check it out!
                                    </div>
                                    <div class="alert alert-success" role="alert">
                                        <strong>Success - </strong> A simple success alertâ€”check it out!
                                    </div>
                                    ...
                                    <div class="alert alert-light text-bg-light border-0" role="alert">
                                        <strong>Light - </strong> A simple light alertâ€”check it out!
                                    </div>
                                    <div class="alert alert-dark text-bg-dark border-0 mb-0" role="alert">
                                        <strong>Dark - </strong> A simple dark alertâ€”check it out!
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-secondary bg-transparent text-secondary" role="alert">
                                        This is a <strong>secondary</strong> alertâ€”check it out!
                                    </div>
                                    <div class="alert alert-success bg-transparent text-success" role="alert">
                                        This is a <strong>success</strong> alertâ€”check it out!
                                    </div>
                                    <div class="alert alert-info bg-transparent text-info" role="alert">
                                        This is a <strong>info</strong> alertâ€”check it out!
                                    </div>
                                    ...
                                    <div class="alert alert-light bg-transparent text-light" role="alert">
                                        This is a <strong>light</strong> alertâ€”check it out!
                                    </div>
                                    <div class="alert alert-dark bg-transparent text-dark mb-0" role="alert">
                                        This is a <strong>dark</strong> alertâ€”check it out!
                                    </div>
