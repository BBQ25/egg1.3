                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to apply a stripe via CSS gradient over the progress barâ€™s background color.</p>
