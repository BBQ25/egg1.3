                                    ...
                                    <div class="row pt-5">
                                        <div class="col-lg-5 offset-lg-1">
                                            ...
                                            <div>
                                                ...
                                                <p class="faq-answer mb-4">Lorem ipsum dolor sit amet, consectetur adipisici elitâ€¦â€™ (complete text) is dummy text that is not meant to mean anything. It is used as a placeholder in magazine layouts, for example, in order to give an impression of the finished document.</p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <p class="faq-answer mb-4">Unfortunately, weâ€™re unable to offer free samples. As a retailer, we buy all magazines from their publishers at the regular trade price. However, you could contact the publisher directly.</p>
                                            </div>
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div>
                                                ...
                                                <p class="faq-answer mb-4">We receive up to 20 enquiries per week from publishers all around the world. Because we canâ€™t always respond to each one right away, all enquiries are checked and answered in chronological order.</p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <p class="faq-answer mb-4">Wow, weâ€™re happy to see more of your great publication. Please find our address on the contact page.</p>
                                            </div>
