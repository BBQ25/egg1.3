                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">Hereâ€™s a quick example to demonstrate Bootstrapâ€™s form styles. Keep reading for documentation on required classes, form layout, and more.</p>
