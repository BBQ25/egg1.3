...
<aside id="layout-menu" class="layout-menu menu-vertical menu" >
  ...
  <div class="app-brand demo ">
    <a href="app-ecommerce-dashboard.html" class="app-brand-link">
      <span class="app-brand-logo demo">
        <img src="../../assets/img/logo.png" alt="APEWSD logo" class="app-brand-logo-img" />
      </span>
      <span class="app-brand-text demo menu-text fw-bold ms-2">APEWSD</span>
    </a>
  ...
  <section id="basic-footer">
    ...
    <footer class="footer bg-light">
      <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-4">
        <div><a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/" target="_blank" class="footer-brand fw-bold">APEWSD</a> ©</div>
        <div>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3 mb-6 mb-sm-0">
            <h4 class="fw-bold mb-4">
              <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/" target="_blank" class="footer-brand">APEWSD</a>
            </h4>
